;(function($){
    ...
    choicesField._populate = function() {
        var $self = this;
        $self.choices.empty();
    ...
    choicesField._display_errors = function(errors) {
        var $self = this;
    ...
    choicesField.get_value_display = function() {
        var $self = this;
    ...
    choicesField._get_value = function() {
