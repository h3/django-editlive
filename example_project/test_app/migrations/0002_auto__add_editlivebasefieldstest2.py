...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'test_app.editlivebasefieldstest2': {
            'Meta': {'object_name': 'EditliveBaseFieldsTest2', '_ormbases': ['test_app.EditliveBaseFieldsTest']},
            'editlivebasefieldstest_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['test_app.EditliveBaseFieldsTest']", 'unique': 'True', 'primary_key': 'True'})
        }
    }
